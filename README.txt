...
For this you need just a scene with a single characterized character and it's control rig. This scene should contain an animation ploted on Take01 and the pose ploted on Take02, both with "Plot on all keys" active, plus an empty or not Take03. It work as:
